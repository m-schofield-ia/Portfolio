/*****************************************************************************
 *
 * CEventorGenCond Generic Conduit Entry Points Source File
 *
 ****************************************************************************/
#define STRICT 1
...
//     Function:        DllMain()
//
//     Description:    main entry point to the Eventor component
//
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    ...
    {
        TRACE0("CEventorGenCond Initializing!\n");
    ...
    {
        TRACE0("CEventorGenCond Terminating!\n");
...
ExportFunc long OpenConduit(PROGRESSFN pFn, CSyncProperties& rProps)
{
    ...
    if (pFn)
    {
	CEventorSync* pGeneric;
	pGeneric = new CEventorSync(rProps, GENERIC_FLAG_CATEGORY_SUPPORTED | GENERIC_FLAG_APPINFO_SUPPORTED );
        if (pGeneric){
