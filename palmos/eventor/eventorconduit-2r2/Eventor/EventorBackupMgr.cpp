/*****************************************************************************
 *
 * Generic Conduit CEventorBackupMgr Src File
 *
 ****************************************************************************/
 ...
 *
 *****************************************************************************/
CEventorBackupMgr::CEventorBackupMgr(CPLogging *pLogging, DWORD dwGenericFlags, char *szDbName, TCHAR *pFileName, TCHAR *pDirName, eSyncTypes syncType)
: CEventorPCMgr(pLogging, dwGenericFlags, szDbName, pFileName, pDirName, syncType)
{
    TRACE0("CEventorBackupMgr Constructor\n");
 ...
 *
 *****************************************************************************/
CEventorBackupMgr::~CEventorBackupMgr()
{
    TRACE0("CEventorBackupMgr Destructor\n");
}
 ...
 *
 *****************************************************************************/
long CEventorBackupMgr::Close(BOOL bDontUpdate)
{
    return CloseDB(TRUE);
}
 ...
 *
 *****************************************************************************/
long CEventorBackupMgr::PostSync(void)
{
 ...
 *
 *****************************************************************************/
long CEventorBackupMgr::OpenDB(void)
{
    long retval = 0;
 ...
 *
 *****************************************************************************/
long CEventorBackupMgr::PreSync(void)
{
    long retval = 0;
    if (m_bAlreadyLoaded)
        return 0;
