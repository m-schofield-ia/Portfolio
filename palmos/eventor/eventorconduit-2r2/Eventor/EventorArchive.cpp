/*****************************************************************************
 *
 * Generic Conduit CEventorArchive Src File
 *
 ****************************************************************************/
 ...
 * from CArchiveDatabase to CEventorArchive.
 */

/******************************************************************************
 *
 * Class:   CEventorArchive
 *
 * Method:  Constructor
 *
 ...
 *
 *****************************************************************************/
CEventorArchive::CEventorArchive(CPLogging *pLogging, DWORD dwGenericFlags, char *szDbName, TCHAR *pFileName, TCHAR *pDirName)
: CEventorPCMgr(pLogging, dwGenericFlags, szDbName, pFileName, pDirName, eFast)
{
    TRACE0("CEventorArchive Constructor\n");
 ...
 *
 *****************************************************************************/
CEventorArchive::~CEventorArchive()
{
    TRACE0("CEventorArchive Destructor\n");
}
 ...
 *
 *****************************************************************************/
long CEventorArchive::PostSync(void)
{
    long retval;
    m_bStartSync = FALSE;
    retval = StoreDB();
 ...
 *
 *****************************************************************************/
long CEventorArchive::OpenDB(void)
{
    long retval = 0;
 ...
 *
 *****************************************************************************/
long CEventorArchive::PreSync(void)
{
    long retval = 0;
    if (m_bAlreadyLoaded)
        return 0;
