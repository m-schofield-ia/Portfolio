                ...
                unsigned int len)
{
	...
	MemMove(&ks->sbox1[0], sbox1, sizeof(sbox1));
	MemMove(&ks->sbox2[0], sbox2, sizeof(sbox2));
	MemMove(&ks->sbox3[0], sbox3, sizeof(sbox3));
	MemMove(&ks->sbox4[0], sbox4, sizeof(sbox4));
 ...
 *	blowfishencrypt
 *
 *	Encrypts 64 bits starting at src.
 *
 *	Input:
 *              ks - key set.
                ...
                unsigned long *l2)
{
	...
	unsigned long *sb1=&ks->sbox1[0], *sb2=&ks->sbox2[0], *sb3=&ks->sbox3[0], *sb4=&ks->sbox4[0];
	unsigned long *pa=&ks->parray[0];
 ...
 *	blowfishdecrypt
 *
 *	Decrypts 64 bits starting at src.
 *
 *	Input:
 *              ks - key set.
