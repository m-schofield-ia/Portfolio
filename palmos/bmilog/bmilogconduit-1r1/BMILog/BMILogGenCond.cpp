/*****************************************************************************
 *
 * CBMILogGenCond Generic Conduit Entry Points Source File
 *
 ****************************************************************************/
#define STRICT 1
...
//     Function:        DllMain()
//
//     Description:    main entry point to the BMILog component
//
...
DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    ...
    {
        TRACE0("CBMILogGenCond Initializing!\n");
    ...
    {
        TRACE0("CBMILogGenCond Terminating!\n");
...
ExportFunc long OpenConduit(PROGRESSFN pFn, CSyncProperties& rProps)
{
    ...
    if (pFn)
    {
	CBMILogSync* pGeneric;
		pGeneric = new CBMILogSync(rProps, 0 );
        if (pGeneric){
