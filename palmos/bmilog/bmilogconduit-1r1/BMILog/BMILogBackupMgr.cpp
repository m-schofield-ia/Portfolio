/*****************************************************************************
 *
 * Generic Conduit CBMILogBackupMgr Src File
 *
 ****************************************************************************/
 ...
 *
 *****************************************************************************/
CBMILogBackupMgr::CBMILogBackupMgr(CPLogging *pLogging, DWORD dwGenericFlags, char *szDbName, TCHAR *pFileName, TCHAR *pDirName, eSyncTypes syncType)
: CBMILogPCMgr(pLogging, dwGenericFlags, szDbName, pFileName, pDirName, syncType)
{
    TRACE0("CBMILogBackupMgr Constructor\n");
 ...
 *
 *****************************************************************************/
CBMILogBackupMgr::~CBMILogBackupMgr()
{
    TRACE0("CBMILogBackupMgr Destructor\n");
}
 ...
 *
 *****************************************************************************/
long CBMILogBackupMgr::Close(BOOL bDontUpdate)
{
 ...
 *
 *****************************************************************************/
long CBMILogBackupMgr::PostSync(void)
{
    long retval = CloseDB(TRUE);
    if (retval)
        return retval;
 ...
 *
 *****************************************************************************/
long CBMILogBackupMgr::OpenDB(void)
{
    long retval = 0;
 ...
 *
 *****************************************************************************/
long CBMILogBackupMgr::PreSync(void)
{
    long retval = 0;
    if (m_bAlreadyLoaded)
        return 0;
