...
import com.first5km.media.Feedback;
import com.first5km.media.MainScreenGestureDetector;
import com.first5km.util.Locale;
import com.first5km.util.Preferences;
...
public class First5kmActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gestureDetector = new GestureDetector(getBaseContext(), (OnGestureListener) mainScreenGestureDetector);
        redraw();
    }
	...
	@Override
 	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.first5kmmenu, menu);
		return true;
 	}
