 ...
 *     <taskdef name="trl"
 *              classname="dk.schau.MEDevTools.TrlClassCreator"
 *              classpath="jar_path" />
 * </target>
 *
...
public class TrlClassCreator extends Task {
	...
	public void execute() throws BuildException {
		if (showVersion) {
			log("TrlClassCreator v" + Version.VERSION + " (http://www.schau.com/)");
		}
		...
		try {
			...
			if ((notInBase > 0) || (notInStrings > 0)) {
				log("Not in BASE: " + notInBase);
				log("Not in STRINGS: " + notInStrings);
			}
		} catch (Exception ex) {
