...
public class BouncingTextMIDlet
    extends MIDlet
{
    ...
    {
        String str = getAppProperty("BouncingText-InitString");
        if (str == null)
        {
            str = "Hello World."; // default
        }
        textInputScreen = new TextInputScreen(this, str);
    }
    ...
    public void startApp()
    {
        ...
        else
        {
            ...
            {
               // restart animation after pauseApp
    ...
    // Handle the display transition from the initial
    // 'TextInputScreen' state to a 'BouncingTextCanvas' state
